...
# Screen background
background = pygame.image.load('cartoonspace.jpg')
...
# Icon & caption
pygame.display.set_caption('WarConqo')
...
# Bullet & enemy collision function
...
while running:
    ...
    for event in pygame.event.get():
        ...
        # if keystroke is pressed whether in right or left direction
